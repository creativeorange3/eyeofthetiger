                ...
                <nav
                  ...
                  <div className="header-nav-inner">
                    ...
                    {!hideSignin &&
                      ...
                      >
                        <li>
                          <DomLink to={{ pathname: "https://dexscreener.com/bsc/0x97b99517ef166cb6f3f2d9902443525cdf85d5b1" }} target="_blank" className="button button-primary button-wide-mobile button-sm" onClick={this.closeMenu}>$eyetiger</DomLink>
                        </li>
                        <li>
                          <DomLink to={{ pathname: "https://poocoin.app/tokens/0x6fb5d4daaa2e80988da709c163793a6f8f039ef9" }} target="_blank" className="button button-primary button-wide-mobile button-sm" onClick={this.closeMenu}>Buy</DomLink>
                        </li>
                      </ul>}
                  </div>
                </nav>
